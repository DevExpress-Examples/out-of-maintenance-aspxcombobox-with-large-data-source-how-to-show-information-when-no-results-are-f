...
Public NotInheritable Class MyDataSource
	...
	Private Sub New()
	End Sub
	Public Shared Function GetData() As IQueryable(Of MyDataSourceItem)
		Dim ds As New List(Of MyDataSourceItem)()
		For i As Integer = 0 To 99
			ds.Add(New MyDataSourceItem() With {.Text = String.Format("Car#{0}", i), .Value = i})
		Next i
